...
<body>
    <div class="chat-container">
        ...
        <?php
	// chat.php の冒頭のAPIエンドポイント設定部分を修正
	//
        // ★★★ ここに生成されたLambda Function URLを貼り付けてください ★★★
        // 例: https://xxxxxxxxx.lambda-url.ap-northeast-1.on.aws/
        $lambdaFunctionUrl = 'https://lffcxvhtolprv5opvx4kjjs2lu0uphmn.lambda-url.ap-northeast-1.on.aws/'; 
	
	// Lambda Function URLはパスを含むので、直接エンドポイントとして指定
	$messagesApiEndpoint = $lambdaFunctionUrl . 'messages'; 
	$searchApiEndpoint = $lambdaFunctionUrl . 'messages/search'; // /messages/search にはAPI Gatewayのパスマッピングで対応
